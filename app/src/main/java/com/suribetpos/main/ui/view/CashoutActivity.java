...
import com.suribetpos.main.ui.fragments.cashout.TodaysVoucherFragment;
...
public class CashoutActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_cashout);
        Initialization();
        ToolBarView();
        RefreshBalance();
        //setToolBar();
        /*Fragment for cashout Details*/
        setupViewPager(cashout_viewPager);
        cashout_viewPager.setCurrentItem(Common.SelectedTabPosition);
        //cashout_viewPager.setOffscreenPageLimit(1);
        ...
        builder1.setNegativeButton(CommonMessage(R.string.Okay),
                (dialog, id) -> {
                    try {
                        ...
                        AlertDialogBox(CommonMessage(R.string.cashout), ex.toString(), false);
                    }
                    dialog.cancel();
                });
    ...
    public void ToolBarView() {
        ...
        toolbarTitle.setText(CommonMessage(R.string.cashout));
