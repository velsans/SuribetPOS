...
import com.suribetpos.main.ui.fragments.etopup.CreateFragment;
import com.suribetpos.main.ui.fragments.etopup.TodaysVoucherFragment;
...
public class ETopUpActivity extends BaseActivity {
    ...
    ArrayList<BalanceAmountModel> BalanceAmountList = new ArrayList<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_etopup);
        Initialization();
        ToolBarView();
        RefreshBalance();
        //setToolBar();
        ...
        /*exportDetails_swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new CreateFragment(), CommonMessage(R.string.Create));
        adapter.addFrag(new TodaysVoucherFragment(), CommonMessage(R.string.Transaction));
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            AlertDialogBox(CommonMessage(R.string.EtopUp), ex.toString(), false);
                        }
                        dialog.cancel();
                    }
                });
    ...
    public void ToolBarView() {
        ...
        toolbarTitle.setText(CommonMessage(R.string.EtopUp));
    ...
    private void YesOnClickListner() {
        Intent intent = new Intent(ETopUpActivity.this, UserAuthenticationActivity.class);
