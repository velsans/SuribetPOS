...
public class DGBetPrintDetails {
    ...
    private String Barcode, BetNumber, Multiplier, CurrencyCode, SlipTime, ExpiryDate, WinningAmount, LocationDescription, CountryName,
    ...
    public int StatusId;
    public double StakeInLocalCurrency, Stake;
