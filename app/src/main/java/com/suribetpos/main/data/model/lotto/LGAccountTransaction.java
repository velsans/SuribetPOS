...
public class LGAccountTransaction {
    int CashDeskJournal,AccountTypeId,TransactionTypeId,TillId,UserId,CurrencyId,DenominationTypeId,Contra,CustomerId;
    double Paid,Received,DenominationTypeTotal,Amount,AmountLocal;
    String Comments,GamingDate,TransactionDateTime;
