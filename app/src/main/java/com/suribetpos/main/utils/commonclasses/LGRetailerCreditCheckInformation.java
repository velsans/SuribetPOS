...
import com.suribetpos.main.interfaces.LGRetailerCreditCheckInformationInterface;
...
*/
/**
 * Created by Velmurugan on 1/17/2018.
 *//*


public class LGRetailerCreditCheckInformation extends AsyncTask<Object, Object, Object> {

    private LGRetailerCreditCheckInformationInterface listener = null;

    public LGRetailerCreditCheckInformation(LGRetailerCreditCheckInformationInterface asyncResponse) {
    ...
    protected Object doInBackground(Object[] params) {
        ...
        String ControllerName = ServiceURL.ServiceURLPathLocalottoGNetwork;
        Uri.Builder DGUrlPLD = new Uri.Builder();
        DGUrlPLD.appendPath("LottoGameMOB")// Controllor
    ...
    protected void onPostExecute(Object result) {
        listener.onLGRetailerCreditCheckDetails(result);
